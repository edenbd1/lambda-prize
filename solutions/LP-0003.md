...
- **Deployment + how to re-verify:** [`docs/DEPLOYMENT.md`](https://github.com/edenbd1/lp-0003-private-airdrop-distributor/blob/main/docs/DEPLOYMENT.md)
- **Basecamp app:** `app/lp-0003-airdrop.lgx` (SHA-256 `3d129c9ac58a2f8c20343fc84daae2083061e7f20e990d8bdcab8884d8b54581`), with both `darwin-arm64` and `linux-amd64` variants
...
[`artifacts/e2e/claims.tsv`](https://github.com/edenbd1/lp-0003-private-airdrop-distributor/blob/main/artifacts/e2e/claims.tsv). A claim is a
...
the source of truth (measured, see [`docs/DEPLOYMENT.md`](https://github.com/edenbd1/lp-0003-private-airdrop-distributor/blob/main/docs/DEPLOYMENT.md)).
...
scope is stated plainly in [`docs/limitations.md`](https://github.com/edenbd1/lp-0003-private-airdrop-distributor/blob/main/docs/limitations.md).
...
on the privacy path. See [`docs/privacy-model.md`](https://github.com/edenbd1/lp-0003-private-airdrop-distributor/blob/main/docs/privacy-model.md).
...
Stated in [`docs/limitations.md`](https://github.com/edenbd1/lp-0003-private-airdrop-distributor/blob/main/docs/limitations.md): the encrypted bundle
...
- [x] **An on-chain observer cannot link a claim to an address.** Secret-bound
      nullifier; see [`docs/privacy-model.md`](https://github.com/edenbd1/lp-0003-private-airdrop-distributor/blob/main/docs/privacy-model.md).
- [x] **Full privacy model documented**, with threat model and named residual
      leakage. [`docs/privacy-model.md`](https://github.com/edenbd1/lp-0003-private-airdrop-distributor/blob/main/docs/privacy-model.md),
      [`docs/limitations.md`](https://github.com/edenbd1/lp-0003-private-airdrop-distributor/blob/main/docs/limitations.md).
- [x] **Reference integration on testnet.** `scripts/deploy-and-claim.sh` runs the
      ...
      [`artifacts/e2e/claims.tsv`](https://github.com/edenbd1/lp-0003-private-airdrop-distributor/blob/main/artifacts/e2e/claims.tsv).
...
- [x] **Basecamp app GUI with local build instructions and a loadable asset.**
      ...
      claim; see [`app/README.md`](https://github.com/edenbd1/lp-0003-private-airdrop-distributor/blob/main/app/README.md).
...
- [x] **Deterministic, documented error codes.** `4001`–`4006` in
      [`docs/error-codes.md`](https://github.com/edenbd1/lp-0003-private-airdrop-distributor/blob/main/docs/error-codes.md), each mapped to the attack it
      stops and the test that proves it.

### Performance

- [x] **CU cost of each on-chain operation documented.**
      [`docs/benchmarks/cu-budget.md`](https://github.com/edenbd1/lp-0003-private-airdrop-distributor/blob/main/docs/benchmarks/cu-budget.md): `claim` is
      318,242 user cycles, padded to 524,288 proving cycles — 0.95% and 1.56%
      respectively of the 33,554,432 public budget. The 1.56% figure is the one
      the budget is charged against. Measured by replaying through the
      sequencer's own executor and reproducible with one command.
      `create_distribution` is lighter (a single PDA init).
...
- [`docs/privacy-model.md`](https://github.com/edenbd1/lp-0003-private-airdrop-distributor/blob/main/docs/privacy-model.md) — threat model, what is hidden
  from whom, what is deliberately public, residual leakage
- [`docs/limitations.md`](https://github.com/edenbd1/lp-0003-private-airdrop-distributor/blob/main/docs/limitations.md) — scope boundaries and deferred
  hardenings
- [`docs/error-codes.md`](https://github.com/edenbd1/lp-0003-private-airdrop-distributor/blob/main/docs/error-codes.md)
- [`docs/benchmarks/cu-budget.md`](https://github.com/edenbd1/lp-0003-private-airdrop-distributor/blob/main/docs/benchmarks/cu-budget.md)
- [`docs/DEPLOYMENT.md`](https://github.com/edenbd1/lp-0003-private-airdrop-distributor/blob/main/docs/DEPLOYMENT.md) — every tx hash and how to re-verify
- [`docs/onchain-audit.md`](https://github.com/edenbd1/lp-0003-private-airdrop-distributor/blob/main/docs/onchain-audit.md) — live adversarial demos
- Narrated demo video: <https://youtu.be/rtCGv0zqC4I>
...
2. **The block explorer and the privacy design are two separate things, and
   ...
   [`docs/DEPLOYMENT.md`](https://github.com/edenbd1/lp-0003-private-airdrop-distributor/blob/main/docs/DEPLOYMENT.md) shows the full measurement.
