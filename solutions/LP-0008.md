...
- **Where the detail lives:** [`docs/criteria-evidence.md`](https://github.com/edenbd1/lp-0008-autonomous-agent-module/blob/42b922fa1cc18c3c8fe0884dbbde7e0ff35afa83/docs/criteria-evidence.md) (the long form of every
  criterion), [`docs/architecture.md`](https://github.com/edenbd1/lp-0008-autonomous-agent-module/blob/42b922fa1cc18c3c8fe0884dbbde7e0ff35afa83/docs/architecture.md), [`docs/skills.md`](https://github.com/edenbd1/lp-0008-autonomous-agent-module/blob/42b922fa1cc18c3c8fe0884dbbde7e0ff35afa83/docs/skills.md), [`docs/security-model.md`](https://github.com/edenbd1/lp-0008-autonomous-agent-module/blob/42b922fa1cc18c3c8fe0884dbbde7e0ff35afa83/docs/security-model.md),
  [`docs/a2a-binding.md`](https://github.com/edenbd1/lp-0008-autonomous-agent-module/blob/42b922fa1cc18c3c8fe0884dbbde7e0ff35afa83/docs/a2a-binding.md), [`docs/limitations.md`](https://github.com/edenbd1/lp-0008-autonomous-agent-module/blob/42b922fa1cc18c3c8fe0884dbbde7e0ff35afa83/docs/limitations.md), [`docs/DEPLOYMENT.md`](https://github.com/edenbd1/lp-0008-autonomous-agent-module/blob/42b922fa1cc18c3c8fe0884dbbde7e0ff35afa83/docs/DEPLOYMENT.md),
  [`docs/basecamp.md`](https://github.com/edenbd1/lp-0008-autonomous-agent-module/blob/42b922fa1cc18c3c8fe0884dbbde7e0ff35afa83/docs/basecamp.md), [`docs/benchmarks/cu-budget.md`](https://github.com/edenbd1/lp-0008-autonomous-agent-module/blob/42b922fa1cc18c3c8fe0884dbbde7e0ff35afa83/docs/benchmarks/cu-budget.md).
...
- [x] **MET — End-to-end integration tests run against a LEZ sequencer (standalone mode) and are included in CI.**
  `scripts/e2e-local-sequencer.sh` against a standalone sequencer with `RISC0_DEV_MODE=0`, no skip path: run [`33093872580`](https://github.com/edenbd1/lp-0008-autonomous-agent-module/actions/runs/33093872580) on `1956340`, an ancestor of the reviewed commit — the delta to the reviewed commit is documentation, the `messaging.join` fix, the storage encryption and the rebuilt packages, none touching the spending lifecycle this run proves. 3 h 16, of which 58 min are real `claim_agent` proving — its log prints `claim_agent: 0h58m04s`.

- [x] **MET — CI must be green on the default branch.**
  Green on `main` and on the reviewed commit specifically: run [`33199329323`](https://github.com/edenbd1/lp-0008-autonomous-agent-module/actions/runs/33199329323), the full CI suite — every skill compiled and exercised against fake ports including the encrypted storage round trip, the package-freshness gate and the SDK third-party-skill example — is green, its head_sha the reviewed commit.
...
- [x] **MET — A recorded video demo of the end-to-end flow is included in the submission; the recording must show terminal output (including proof generation) to confirm `RISC0_DEV_MODE=0` was active.**
  «NEW_VIDEO_URL» — a walkthrough narrated by the author, covering the architecture and the implementation choices, the CLI, and the agent running inside the Basecamp app; terminal output shows `RISC0_DEV_MODE=0` throughout proof generation, against the public testnet. See Supporting Materials.
...
- **Video demo:** «NEW_VIDEO_URL» — a walkthrough narrated by the author, covering the
  architecture and the implementation choices, the command-line tooling, and the agent
  running inside the Basecamp owner interface. It runs against the public testnet, never
  a localnet, with `RISC0_DEV_MODE=0` legible throughout the proving output. The same
  file is mirrored as a repository release asset, so the evidence does not depend on a
  third party keeping it up.
