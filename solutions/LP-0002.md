...
- **Reviewed commit:**
  [`af9319e`](https://github.com/edenbd1/lp-0002-private-multisig/tree/af9319ebc933f7599a88d591f2200eb75d1694ec).
...
- **CI on that commit:** the host suite and the deployed-binary audit — **131
  ...
  pinned revision, driven with real proofs — runs on `1759015`: run [`33098969090`](https://github.com/edenbd1/lp-0002-private-multisig/actions/runs/33098969090),
  green in 2 h 39, its log printing `RISC0_DEV_MODE=0` and closing on `2 approval(s)
  recorded against a requirement of 2`. `git diff 1759015 af9319e --stat` is five
...
- **Video:** «NEW_VIDEO_URL» — a single walkthrough narrated by the author, covering
  the architecture and the implementation choices, the CLI lifecycle (create → propose
  → shielded approvals → execute → rotation, with a spending tier), and the module
  running inside the Basecamp app. It shows a full lifecycle against a standalone
  sequencer with real proofs, `RISC0_DEV_MODE=0` on screen, and the commit it was shot
  at. Committed under `recordings/` so a bare clone carries it.
- **Where the detail lives:** [`docs/security.md`](https://github.com/edenbd1/lp-0002-private-multisig/blob/af9319ebc933f7599a88d591f2200eb75d1694ec/docs/security.md) (threat model),
  [`docs/cu-costs.md`](https://github.com/edenbd1/lp-0002-private-multisig/blob/af9319ebc933f7599a88d591f2200eb75d1694ec/docs/cu-costs.md), [`docs/error-codes.md`](https://github.com/edenbd1/lp-0002-private-multisig/blob/af9319ebc933f7599a88d591f2200eb75d1694ec/docs/error-codes.md), [`docs/lez-account-model.md`](https://github.com/edenbd1/lp-0002-private-multisig/blob/af9319ebc933f7599a88d591f2200eb75d1694ec/docs/lez-account-model.md),
  [`docs/account-layout.md`](https://github.com/edenbd1/lp-0002-private-multisig/blob/af9319ebc933f7599a88d591f2200eb75d1694ec/docs/account-layout.md), [`docs/DEPLOYMENT.md`](https://github.com/edenbd1/lp-0002-private-multisig/blob/af9319ebc933f7599a88d591f2200eb75d1694ec/docs/DEPLOYMENT.md), `vendor/spel/PATCH.md`.
...
A **3-of-3** multisig with a spending tier, deployed 2026-09-10: created, funded,
a transfer proposed, approved and executed — then the same member set voted to
replace itself. **Thirteen transactions, eleven of them in blocks 1952–2613 and
the two program deploys earlier at blocks 1359–1360; five are on the proving path.**

| Step | Transaction | Block |
|---|---|---:|
| deploy `membership_lez` | [`fb8eb10f…a589bea98`](https://explorer.testnet.lez.logos.co/transaction/fb8eb10f7f394286c109cb6502a1c95294180523f30d06f707fc087a589bea98) | 1360 |
| deploy `multisig_verifier` | [`268834b6…4be31aa3`](https://explorer.testnet.lez.logos.co/transaction/268834b601f78b59090e90f8f10fd8ce3b526528e1224983edba95224be31aa3) | 1359 |
| `create_multisig` | [`dd2d8acb…57012995`](https://explorer.testnet.lez.logos.co/transaction/dd2d8acba88bef5f23ea2c2fbe8386949e5082c9aaedc34de53fbdcb57012995) | 1952 |
| `fund_treasury` | [`c92cabe1…8e92f2c6`](https://explorer.testnet.lez.logos.co/transaction/c92cabe1f1ba3ce92fbbdc992cd75a8f34be381d0eb54d0e1d9987468e92f2c6) | 1953 |
| `create_proposal` | [`af7e257e…887a662e`](https://explorer.testnet.lez.logos.co/transaction/af7e257e56144d53f634198c2eecbecdb2c944e1267fd01ed6483f88887a662e) | 1954 |
| `approve` A — **privacy tx** | [`91a10451…0a04b042`](https://explorer.testnet.lez.logos.co/transaction/91a1045154df089ae8a5140ea0d6eee2d4824ff4324c7f8e8cb35b6b0a04b042) | 1969 |
| `approve` B — **privacy tx** | [`6f3d65c3…08c9dcf8`](https://explorer.testnet.lez.logos.co/transaction/6f3d65c3c18d3714fd1e228bd75508ec9f9a83e8d1b7213712b92dac08c9dcf8) | 2579 |
| `execute` | [`406bc088…5d3902d5`](https://explorer.testnet.lez.logos.co/transaction/406bc088c129519c11eb74745eb7bb12fa4736946063d42d6bba8cee5d3902d5) | 2580 |
| `create_proposal` (rotation) | [`3ea3449f…1a9e483d`](https://explorer.testnet.lez.logos.co/transaction/3ea3449f95e597ed24b5b3ca1a529ae54d926c17b52ea59a7847cae81a9e483d) | 2581 |
| `approve` A — **privacy tx** | [`c4e9453b…5c6403cf`](https://explorer.testnet.lez.logos.co/transaction/c4e9453bdbff889a6332d9217e47c097e3f2a0ec7a323e01278765075c6403cf) | 2593 |
| `approve` B — **privacy tx** | [`4ef2fd71…09967394`](https://explorer.testnet.lez.logos.co/transaction/4ef2fd7134118af684cdb6b12a15d215e221a6bf8d0c5e7c500314ac09967394) | 2602 |
| `approve` C — **privacy tx** | [`c790525f…9409b375`](https://explorer.testnet.lez.logos.co/transaction/c790525fc7b9404dc1a2b6e6a639e69cf0a1fb7e2f025d82d872917b9409b375) | 2612 |
| `rotate_config` | [`190902e6…b1047139`](https://explorer.testnet.lez.logos.co/transaction/190902e66f62989862564b15a02a167fdeb62e2c0ddf8dcc73ba2cecb1047139) | 2613 |
...
anchored rather than merely applied: `config_hash` is `5efae271…`, and the same
members and threshold *without* the tier give `a6e9fd61…`, a different PDA nobody
...
`6uHSGxEU…` goes **250 → 251**, held by the native transfer program, which is what makes
...
- [x] **A recorded video demo of the end-to-end flow is included in the submission; the recording must show terminal output (including proof generation) to confirm `RISC0_DEV_MODE=0` was active.**
  «NEW_VIDEO_URL» — one take narrated by the author. It shows `RISC0_DEV_MODE=0` before any proving starts and again on the closing `PASS (…, 2-of-3, RISC0_DEV_MODE=0)` line; a real standalone LEZ sequencer is started, both programs deployed, shielded approvals gathered with **real Risc0 proofs**, execution moving value, and the accounts read back. Only the static proving stretch is sped up, with the factor shown on screen. The same walkthrough covers the architecture and the implementation choices and drives the module from both the Basecamp app and the CLI.
